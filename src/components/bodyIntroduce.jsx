    ...
    >
      ...
      >
        <div className={"buttons flex justify-center items-center gap-[242px]"}>
          <button
            className={
              "button_1 text-[24px] font-bold text-gray-500 hover:text-blue-600 hover:underline"
            }
            onClick={() => {
          ...
          <button
            className={
              "button_2  text-[24px] font-bold text-gray-500 hover:text-blue-600 hover:underline"
            }
            onClick={() => {
